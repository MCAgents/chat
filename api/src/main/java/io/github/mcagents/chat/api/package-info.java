 ...
 * types that describe what the chat surface does, never how it does it. No type
 * in this package or below it may reference a Minecraft server, a mod loader,
 * or a MCAgents core class.</p>
 *
 * <p>That last exclusion is deliberate. This project reaches
 ...
 * in this project's own types and a platform module adapts them.</p>
 *
