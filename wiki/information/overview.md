...
| `.agents/` | The agent instruction set — rules, git conventions, planning, security, compliance, platform knowledge, prompts, creators — plus the index, agent-wiki, and memory trees. |
